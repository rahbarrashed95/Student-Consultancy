...
<main>
    <div class="container-fluid px-4">
        ...
        <ol class="breadcrumb mb-4">
            ...
            <li class="breadcrumb-item active">Roles Add</li>
        </ol>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="role" class="form-control" name="name" placeholder="Role name..." value="{{ old('name') }}">
                            </div>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-12 mt-2">
                            ...
                            @foreach($permissions as $permission)
                                <h6><label class="mb-1 mt-2"><input type="checkbox" class="permission-item" name="permissions[]" value="{{$permission->name}}"> {{$permission->name}}</label></h6>
                            @endforeach
                        </div>
                    </div>
                    <hr>
